  ...
  return (
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden border-b-0">
        ...
        <div className="container mx-auto px-4 relative z-20 pt-20">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <h1 className="text-5xl md:text-8xl font-bold tracking-tight mb-8 leading-[0.95]">
              Drop it.
              <br />
              <span className="text-gray-500">We recycle</span>
              <br />
              <span className="text-gray-500">the rest.</span>
            </h1>
            <p className="text-xl text-gray-400 mb-12 max-w-lg mx-auto">
              Free vape and battery recycling at local smoke shops. Fast, safe,
              and always free.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/dropoff">
                <Button
                  size="lg"
                  className="bg-white text-black hover:bg-gray-100 text-base px-10 h-14 rounded-full font-semibold w-full sm:w-auto"
              ...
              <Link href="/business">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/30 text-white hover:bg-white/10 text-base px-10 h-14 rounded-full w-full sm:w-auto"
                  data-testid="button-get-free-bin"
                >
        ...
        <div className="absolute top-5 right-8 z-20 hidden lg:block">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 text-white text-sm">
            <span className="text-green-400 mr-2">✓</span> Trusted by local
            shops
          </div>
        </div>
      </section>
          ...
          <div className="relative h-[50vh] md:h-[70vh]">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <p className="text-gray-300">
                Drop your dead vape. Walk away knowing you did the right thing.
              </p>
            </div>
          </div>
          <div className="relative h-[50vh] md:h-[70vh]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Gather your dead disposable vapes and small lithium batteries.
              </p>
            </div>
            <div className="text-center">
              <div className="relative h-64 mb-6 rounded-2xl overflow-hidden">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Stop by any partner shop and drop them in the LITTR bin.
              </p>
            </div>
            <div className="text-center">
              <div className="relative h-64 mb-6 rounded-2xl overflow-hidden">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We pick up and recycle everything safely. That's it.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 max-w-3xl mx-auto leading-tight text-white">
            Vape batteries cause{" "}
            <span className="text-red-400">300+ landfill fires</span> every
            year.
          </h2>
      ...
      <section
        ...
        data-testid="section-littr-one-teaser"
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative bg-gradient-to-r from-zinc-900 to-zinc-800 rounded-3xl overflow-hidden border border-zinc-700">
              <div
                className="absolute top-4 right-4 bg-green-500 text-black text-xs font-bold px-3 py-1 rounded-full z-10"
                data-testid="badge-now-available"
              >
                NOW AVAILABLE
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8 items-center">
                ...
                <div className="order-1 md:order-2 text-center md:text-left">
                  <p className="text-sm uppercase tracking-widest text-green-500 mb-2">
                    Introducing
                  </p>
                  <h3
                    className="text-3xl md:text-4xl font-bold text-white mb-4"
                    data-testid="heading-littr-one-home"
                  >
                    The LITTR One
                  </h3>
                  <p className="text-gray-400 mb-6">
                    Smart recycling bin with temperature sensors, VOC
                    monitoring, fill detection, and instant QR rewards.
                    WiFi-enabled for real-time alerts.
                  </p>
                  <Link href="/why">
                    <Button
                      className="bg-green-500 hover:bg-green-600 text-black font-semibold rounded-full px-8"
                      data-testid="button-learn-littr-one"
                    >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div className="relative h-80 rounded-2xl overflow-hidden">
              <img
                src={highEndShopImage}
                alt="Partner smoke shop at night"
                className="w-full h-full object-cover"
                style={{ imageRendering: "pixelated" }}
              />
            </div>
            <div>
              ...
              <p className="text-2xl font-light leading-relaxed mb-6">
                "I used to find dead vapes all over the parking lot every
                morning. Now customers just drop them in the bin on their way
                out. Problem solved."
              </p>
              <p className="text-gray-400">
                <span className="font-semibold text-white">Tino</span> — High
                End Smoke Shop, Rochester
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">
                Fire-safe containers and trained pickup crews keep everyone
                safe.
              </p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">
                All materials go to EPA-compliant processing facilities.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <div className="h-12 w-12 rounded-full bg-black text-white flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-500">
                Partners never pay a dime for bin collection or service.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10 text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Make Your Next Drop Count
          </h2>
          <p className="text-xl text-gray-400 mb-10 max-w-md mx-auto">
            Find your nearest location and recycle responsibly in under 30
            seconds.
          </p>
          <Link href="/dropoff">
            <Button
              size="lg"
              className="bg-white text-black hover:bg-gray-100 rounded-full px-12 h-16 text-lg font-semibold"
